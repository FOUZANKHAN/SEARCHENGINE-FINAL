    ...
    while True:
        if initial_indexing:
            ...
            if query_mode == 1:
                ...
                #print("Didn't you see the sign?\n")
                #for cranfield 
                f = open(Path("cranfield_relevance_check/queries"), "r")
                queries = f.readlines()
                #print(queries[1])
                f.close()
                print("Got the test queries!")

                f1 = open(Path("cranfield_relevance_check/qrel"), "r")
                ...
                for i in range(0,len(queries)): 
                    ...
                    print(f"The average precision of the query {queries[i]} is {Averageprecision} \n")
